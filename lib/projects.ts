...
export const projects: Project[] = [
  { slug: "iter-noctis", title: "Iter Noctis", tagline: "Dishonored in death, a pathlees soul not worthy of an afterlife seeks escape from the eternal commute.", description: "Death is the natural part of life for all beings. The afterlife is not. Every soul is judged by the choices they made, each decision etched into their very eyes.", status: "wishlit now", art: "art-a", images: ["/IterNoctis.JPG"], externalUrl: "https://store.steampowered.com/app/4796910/Iter_Noctis/", featured: true, buttonLabel: "Wishlist now"},
